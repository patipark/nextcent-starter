...
function Header() {
  return (
    <div className='bg-[#F5F7FA] h-auto md:h-[37.5rm] flex items-center'>
        <div className='container mx-auto max-w-[2320px] p-10 flex flex-col md:flex-row md:justify-between items-center md:p-0'>
            <div>
