    ...
    <div className="bg-[#263238] py-20">
      <div className="container mx-auto max-w-[1320px]">
        ...
        <div>
            ...
            <p className="my-10 text-[#F5F7FA]">Copyright © 2020 Nexcent ltd.<br/>All rights reserved</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
             <div>
                ...
                <ul className="flex flex-col mb-5">
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">About us</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Blog</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Contact us</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Pricing</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Testimonials</a></li>
                </ul>
             </div>
             <div>
                <h4 className="text-[1.25rem] text-white font-semibold">Support</h4>
                <ul className="flex flex-col mb-5">
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Help center</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Terms of service</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Legal</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Privacy policy</a></li>
                    <li className="mt-2"><a className="text-white text-[0.875rem]" href="#" alt="">Status</a></li>
                </ul>
             </div>
             <div>
